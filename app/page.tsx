        ...
        <div className="mx-auto max-w-[1440px] px-5 sm:px-8 lg:px-12">
          ...
          <div className="flex h-[88px] items-center justify-between">
            ...
            <div className="hidden items-center lg:flex">
              ...
              <nav className="flex items-center gap-7 xl:gap-10">
                ...
                {navigation.map(([label, href], index) => (
                  ...
                  <Link
                    key={label}
                    href={href}
                    className={`group relative py-3 text-[12px] font-semibold tracking-[0.02em] transition-colors duration-300 ${
                      index === 0
                        ? "text-[#101820]"
                  ...
                  >
                    ...
                    <span
                      className={`absolute bottom-0 left-0 h-[2px] bg-[#a77d36] transition-all duration-300 ${
                        index === 0
                          ? "w-full"
              ...
              <Link
                href="/contact"
                className="group ml-8 inline-flex items-center gap-3 rounded-full bg-[#101820] px-6 py-3.5 text-[12px] font-semibold text-white transition duration-300 hover:bg-[#a77d36]"
              >
            ...
            <div>
              ...
              <div className="mt-10 grid gap-10 md:grid-cols-2">
                ...
                <p className="text-[16px] leading-8 text-[#626d76]">
                  Brianno and Family is a professional business advisory and
                  consulting firm established in 2019 to help organisations
                  navigate commercial opportunities with greater clarity.
                </p>

                <p className="text-[16px] leading-8 text-[#626d76]">
                  From growth strategy and tender advisory to international
                  trade and financial consulting, we combine commercial
                  perspective with practical execution.
                </p>
              ...
              {[
                {
                  ...
                  title:
                    "Identifying opportunities for sustainable business growth",
                  description:
                ...
                },
                {
                  ...
                  title:
                    "Exploring opportunities beyond traditional markets",
                  description:
                ...
                },
                {
                  ...
                  title:
                    "Preparing organisations for competitive opportunities",
                  description:
        ...
        <footer className="bg-[#070e14] px-5 py-16 text-white sm:px-8 lg:px-12">
          ...
          <div className="mx-auto max-w-[1440px]">
            ...
            <div className="grid gap-14 lg:grid-cols-[1.5fr_.5fr_.7fr]">
              ...
              <div>
                ...
                <p className="mt-7 max-w-[500px] text-sm leading-7 text-white/35">
                  Professional business advisory and consulting services
                  across business development, tender advisory, international
                  trade and financial consulting.
                </p>
            ...
            <div className="mt-16 flex flex-col justify-between gap-5 border-t border-white/[0.08] pt-7 text-[10px] text-white/25 sm:flex-row sm:items-center">
              ...
              <p>
                © 2026 Brianno and Family. All rights reserved.
              </p>
